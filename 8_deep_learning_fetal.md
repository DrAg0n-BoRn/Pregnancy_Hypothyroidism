...
# Choose Target
from helpers.constants import TARGET_FETAL_DISTRESS as TARGET
```
...
model.data_aware_initialization(train_dataset=dataset.train_dataset, num_samples=500, verbose=1)
